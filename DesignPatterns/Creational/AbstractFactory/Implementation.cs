...
namespace AbstractFactory
{
    ...
    public class ShoppingCart
    {
        ...
        public ShoppingCart(IShoppingCartPurchaseFactory factory)
        {
            ...
            _orderCosts = 200;
            _origin = factory.GetType().Name.Replace("ShoppingCartPurchaseFactory","");
        }

        public void CalculateCosts()
        {
            Console.WriteLine($"Total costs ({_origin}) = {_orderCosts - (_orderCosts / 100 * _discountService.DiscountPercentage) + _shippingCostsService.ShippingCosts }");
        }
    } 
}
